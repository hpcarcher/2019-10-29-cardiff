...
venue: "ARCHER-SSI Data Carpentry at Cardiff University" # brief name of host site without address (e.g., "Euphoric State University")
address: "Training Room 2, Julian Hodge Building, Colum Drive, Cardiff, CF10 3EU" # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
latlng: "51.491910,-3.185430" # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "Oct 29-30, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:30 am - 5 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
startdate: 2019-10-29      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2019-10-30        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Juan Herrera", "Andrew Brooks"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jose Munoz Criollo", "Robert Munn"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["support@archer.ac.uk"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: "https://pad.carpentries.org/2019-10-29-cardiff" # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
...
<p>Please be sure to complete this survey <strong>before</strong> the workshop.</p>
<p><a href="{{ site.dc_pre_survey }}{{ site.github.project_title }}">Pre-workshop Survey</a></p>
<p>Please be sure to complete these surveys <strong>after</strong> the workshop.</p>
<p><a href="https://www.archer.ac.uk/training/feedback/">ARCHER Course feedback</a></p>
